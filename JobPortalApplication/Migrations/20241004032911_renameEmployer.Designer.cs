...
namespace JobPortalApplication.Migrations
{
    ...
    [Migration("20241004032911_renameEmployer")]
    partial class renameEmployer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2022, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9574),
                            ...
                            Phone = "123-456-7890",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9595),
                            Website = "https://www.techinnovators.com"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2021, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9601),
                            ...
                            Phone = "987-654-3210",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9601),
                            Website = "https://www.greenearth.com"
                        },
                        new
                        {
                            Id = 3,
                            Create = new DateTime(2019, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9643),
                            ...
                            Phone = "555-678-1234",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9644),
                            Website = "https://www.healthfirst.com"
                        },
                        new
                        {
                            Id = 4,
                            Create = new DateTime(2023, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9646),
                            ...
                            Phone = "321-987-6543",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9646),
                            Website = "https://www.globalventures.com"
                        },
                        new
                        {
                            Id = 5,
                            Create = new DateTime(2020, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9648),
                            ...
                            Phone = "222-333-4444",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9649),
                            Website = "https://www.futureenergy.com"
                        },
                        new
                        {
                            Id = 6,
                            Create = new DateTime(2018, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9651),
                            ...
                            Phone = "999-888-7777",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 29, 10, 792, DateTimeKind.Local).AddTicks(9652),
