...
namespace JobPortalApplication.Migrations
{
    ...
    [Migration("20241009121513_fix-table-emloyers")]
    partial class fixtableemloyers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2022, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7471),
                            ...
                            Phone = "123-456-7890",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7490),
                            Website = "https://www.techinnovators.com"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2021, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7495),
                            ...
                            Phone = "987-654-3210",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7496),
                            Website = "https://www.greenearth.com"
                        },
                        new
                        {
                            Id = 3,
                            Create = new DateTime(2019, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7498),
                            ...
                            Phone = "555-678-1234",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7498),
                            Website = "https://www.healthfirst.com"
                        },
                        new
                        {
                            Id = 4,
                            Create = new DateTime(2023, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7500),
                            ...
                            Phone = "321-987-6543",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7501),
                            Website = "https://www.globalventures.com"
                        },
                        new
                        {
                            Id = 5,
                            Create = new DateTime(2020, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7503),
                            ...
                            Phone = "222-333-4444",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7504),
                            Website = "https://www.futureenergy.com"
                        },
                        new
                        {
                            Id = 6,
                            Create = new DateTime(2018, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7506),
                            ...
                            Phone = "999-888-7777",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7507),
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Employer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 3,
                            Create = new DateTime(2022, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7566),
                            Email = "contact@techinnovators.com",
                            Fullname = "Phan Duy Cuu",
                            Location = "Bac ruong",
                            Password = "123456789Aa",
                            Status = true,
                            Update = new DateTime(2024, 10, 9, 19, 15, 12, 952, DateTimeKind.Local).AddTicks(7568),
                            Username = "phanduycuu"
                        });
                });
