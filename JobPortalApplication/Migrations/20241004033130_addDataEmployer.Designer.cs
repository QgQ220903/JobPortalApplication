...
namespace JobPortalApplication.Migrations
{
    ...
    [Migration("20241004033130_addDataEmployer")]
    partial class addDataEmployer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2022, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(607),
                            ...
                            Phone = "123-456-7890",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(629),
                            Website = "https://www.techinnovators.com"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2021, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(633),
                            ...
                            Phone = "987-654-3210",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(634),
                            Website = "https://www.greenearth.com"
                        },
                        new
                        {
                            Id = 3,
                            Create = new DateTime(2019, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(636),
                            ...
                            Phone = "555-678-1234",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(637),
                            Website = "https://www.healthfirst.com"
                        },
                        new
                        {
                            Id = 4,
                            Create = new DateTime(2023, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(638),
                            ...
                            Phone = "321-987-6543",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(639),
                            Website = "https://www.globalventures.com"
                        },
                        new
                        {
                            Id = 5,
                            Create = new DateTime(2020, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(641),
                            ...
                            Phone = "222-333-4444",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(642),
                            Website = "https://www.futureenergy.com"
                        },
                        new
                        {
                            Id = 6,
                            Create = new DateTime(2018, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(644),
                            ...
                            Phone = "999-888-7777",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(644),
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Employer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CompanyId = 3,
                            Create = new DateTime(2022, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(664),
                            Email = "contact@techinnovators.com",
                            Fullname = "Phan Duy Cuu",
                            Password = "123456789Aa",
                            Status = true,
                            Update = new DateTime(2024, 10, 4, 10, 31, 30, 386, DateTimeKind.Local).AddTicks(665),
                            Username = "phanduycuu"
                        });
                });
