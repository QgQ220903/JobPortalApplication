...
namespace JobPortalApplication.Migrations
{
    ...
    [Migration("20240930160437_updateCompany")]
            ...
            modelBuilder.Entity("JobPortalApplication.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2022, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3923),
                            ...
                            Phone = "123-456-7890",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3946),
                            Website = "https://www.techinnovators.com"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2021, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3953),
                            ...
                            Phone = "987-654-3210",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3955),
                            Website = "https://www.greenearth.com"
                        },
                        new
                        {
                            Id = 3,
                            Create = new DateTime(2019, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3957),
                            ...
                            Phone = "555-678-1234",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3958),
                            Website = "https://www.healthfirst.com"
                        },
                        new
                        {
                            Id = 4,
                            Create = new DateTime(2023, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3960),
                            ...
                            Phone = "321-987-6543",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3961),
                            Website = "https://www.globalventures.com"
                        },
                        new
                        {
                            Id = 5,
                            Create = new DateTime(2020, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3965),
                            ...
                            Phone = "222-333-4444",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3968),
                            Website = "https://www.futureenergy.com"
                        },
                        new
                        {
                            Id = 6,
                            Create = new DateTime(2018, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3970),
                            ...
                            Phone = "999-888-7777",
                            Status = true,
                            Update = new DateTime(2024, 9, 30, 23, 4, 37, 358, DateTimeKind.Local).AddTicks(3970),
